...
const Projects = () => {
return ( <section className='max-container'> <h1 className='head-text'>
        ...
        <div className='mt-5 flex flex-col'>
          ...
          <div className='flex flex-wrap gap-2 mt-4'>
            {project.techStack?.map((tech) => (
              <span
                key={tech}
                className='px-3 py-1 text-sm font-medium rounded-lg bg-white border border-slate-200 text-slate-700'
              >
                {tech}
              </span>
            ))}
